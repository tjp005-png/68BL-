        ...
        if existing:
            conn.execute('''
                ...
                SET generator = ?, waste_description = ?, win_code = ?, voc_percentage = ?, 
                    ...
                    unloading_instructions = ?, last_synced_mtime = ?
            ...
            ''', (generator, waste_description, win_code, voc_pct, 
                  ...
                  free_liquids, status, lab_number, color, treatment_recipe,
                  shipping_container_type, sample_procedures, verification_procedures,
                  unloading_instructions, excel_mtime, profile_number))
        else:
            conn.execute('''
            ...
            ''', (profile_number, generator, waste_description, win_code, voc_pct, 
                  ...
                  dot_description, cyanide, sulfide, free_liquids, lab_number, color, treatment_recipe,
                  shipping_container_type, sample_procedures, verification_procedures,
                  unloading_instructions, excel_mtime))
        conn.commit()
        ...
        for file in files:
            if file and file.filename != '':
                ...
                try:
                    ...
                    if os.path.exists(r"I:\\") or os.path.exists(r"I:\Buttonwillow"):
                        for i_dir in i_dirs:
